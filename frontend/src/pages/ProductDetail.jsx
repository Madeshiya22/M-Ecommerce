        ...
        <div className="pd-layout">
          ...
          <div className="pd-info">
            ...
            <div className="pd-actions">
              ...
              <button className="btn btn-ghost pd-wishlist-btn" title="Add to Wishlist" onClick={() => toast('Added to wishlist ♥')}>
                <FiHeart size={18} />
              </button>
                  ...
                  <form className="pd-review-form" onSubmit={handleReview}>
                    ...
                    <div className="form-group">
                      ...
                      <div className="pd-review-stars">
                        {[1,2,3,4,5].map(s => (
                          <button key={s} type="button" onClick={() => setReviewForm({...reviewForm, rating: s})} style={{ fontSize: '1.3rem', color: s <= reviewForm.rating ? 'var(--clr-gold)' : 'var(--clr-text-faint)' }}>★</button>
                        ))}
                      </div>
                    </div>
                    <div className="form-group">
